CREATE TABLE entrepot_donnee_candidat_archives(
id INT8 PRIMARY KEY,
annee INT8,
...
CREATE SEQUENCE entrepot_donnee_candidat_archives_id_seq START WITH 1 INCREMENT BY 50;
ALTER TABLE entrepot_donnee_candidat_archives ALTER COLUMN id SET DEFAULT nextval('entrepot_donnee_candidat_archives_id_seq');